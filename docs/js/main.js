	...
	var global = {
		...
		*/
		resetData: function(msgFlag) {
			...
			tempNMData=[
				['20',	'白き支配者「雪の女王」',		'ユキンコ',				'25',	'',		'21.0',	'26.2',	'[2]雪の女王',			'女王',		'女王'		],
				...
				['29',	'円卓の霧王「キングアースロ」',		'バル・スニッパー',			'34',	'霧?',		'8',	'15',	'[11]キングアースロ',		'アースロ',		'アースロ'	],
				['30',	'唇亡びて歯寒し(エルダータウルス)',	'ラボラトリー・ミノタウロス',		'35',	'',		'13',	'19',	'[12]エルダータウルス',		'タウルス',		'タウルス'	],
				['31',	'野牛の救い主「エウレカの聖牛」',	'エルダーバッファロー',			'36',	'',		'25',	'17',	'[14]エウレカの聖牛',		'聖牛',		'聖牛'		],
				['32',	'雷雲の魔獣「ハダヨッシュ」',		'ヴォイド・レッサードラゴン',		'37',	'雷',		'31',	'18.5',	'[15]ハダヨッシュ',		'ハダヨッシュ',	'ヨッシュ'	],
				['33',	'太陽の使者「ホルス」',			'ヴォイド・ヴィーヴル',			'38',	'灼熱波?',	'25',	'19',	'[16]ホルス',			'ホルス',		'ホルス'	],
				['34',	'闇眼王「アーチ・アンラ・マンユ」',	'ガウパー',				'39',	'',		'23',	'25',	'[17]アーチ・アンラ・マンユ',	'マンユ',		'マンユ'	],
				['35',	'模倣犯「コピーキャット・キャシー」',	'アムルタート、グリフィン、キメラ',	'40',	'吹雪?',	'22',	'14',	'[18]コピーキャット・キャシー',	'キャシー',		'キャシー'	],
				['35',	'蒼き氷刃「ロウヒ」',			'バル・コープス',			'40',	'吹雪?',	'36',	'19',	'[19]ロウヒ',			'ロウヒ',		'ロウヒ'	],
				['',	'',					'',					'',	'',		'99',	'99',	'',				'',			''		],
				['',	'',					'',					'',	'',		'99',	'99',	'',				'',			''		],
				['',	'',					'',					'',	'',		'99',	'99',	'',				'',			''		]
			];
