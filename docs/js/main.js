		...
		*/
		resetData: function(msgFlag) {
			...
			tempNMData=[
				...
				['29',	'円卓の霧王「キングアースロ」',		'バル・スニッパー',			'34',	'霧?',		'8',	'15',	'[11]キングアースロ',		'アースロ',		],
				...
				['32',	'雷雲の魔獣「ハダヨッシュ」',		'ヴォイド・レッサードラゴン',		'37',	'雷',		'28',	'17',	'[15]ハダヨッシュ',		'ハダヨッシュ',	],
				['33',	'太陽の使者「ホルス」',			'ヴォイド・ヴィーヴル',			'38',	'',		'25',	'19',	'[16]ホルス',			'ホルス',		],
				['34',	'闇眼王「アーチ・アンラ・マンユ」',	'ガウパー',				'39',	'',		'23',	'25',	'[17]アーチ・アンラ・マンユ',	'マンユ',		],
				['35',	'模倣犯「コピーキャット・キャシー」',	'アムルタート、グリフィン、キメラ',	'40',	'吹雪?',	'22',	'14',	'[18]コピーキャット・キャシー',	'キャシー',		],
				['35',	'蒼き氷刃「ロウヒ」',			'バル・コープス',			'40',	'吹雪?',	'36',	'19',	'[19]ロウヒ',			'ロウヒ',		],
				['',	'予備',　				'不明',					'',	'',		'99',	'99',	'',				'',			]
			];
