		...
		*/
		resetData: function(msgFlag) {
			...
			tempNMData=[
				...
				['26',	'動く雪洞「キングイグルー」',		'フワシ',				'31',	'',		'17.1',	'16.1',	'[8]キングイグルー',		'イグルー',		'イグルー'	],
				...
				['33',	'太陽の使者「ホルス」',			'ヴォイド・ヴィーヴル',			'38',	'灼熱波',	'25.9',	'20.2',	'[16]ホルス',			'ホルス',		'ホルス'	],
				['34',	'闇眼王「アーチ・アンラ・マンユ」',	'ガウパー',				'39',	'',		'23.7',	'25.0',	'[17]アーチ・アンラ・マンユ',	'マンユ',		'マンユ'	],
				['35',	'模倣犯「コピーキャット・キャシー」',	'アムルタート',				'40',	'吹雪',		'22.2',	'14.2',	'[18]コピーキャット・キャシー',	'キャシー',		'キャシー'	],
			...
			tempNMList = [
				...
				['Queen:(..):(..)','NM01'],['Taxim:(..):(..)','NM02'],['AshDragon:(..):(..)','NM03'],['Glavoid:(..):(..)','NM04'],['Anapos:(..):(..)','NM05'],['Hakutaku:(..):(..)','NM06'],['Igloo:(..):(..)','NM07'],['Asag:(..):(..)','NM08'],['Surabhi:(..):(..)','NM09'],['Arthro:(..):(..)','NM10'],['Mindertaur:(..):(..)','NM11'],['HolyCow:(..):(..)','NM12'],['Hadhayosh:(..):(..)','NM13'],['Horus:(..):(..)','NM14'],['Mainyu:(..):(..)','NM15'],['Cassie:(..):(..)','NM16'],['Louhi:(..):(..)','NM17'],
				['([0-9]+):([0-9]+):[0-9]+.*雪の女王','NM01'],
				['([0-9]+):([0-9]+):[0-9]+.*タキシム','NM02'],
				['([0-9]+):([0-9]+):[0-9]+.*アッシュドラゴン','NM03'],
				['([0-9]+):([0-9]+):[0-9]+.*グラヴォイド','NM04'],
				['([0-9]+):([0-9]+):[0-9]+.*アナポ','NM05'],
				['([0-9]+):([0-9]+):[0-9]+.*ハクタク','NM06'],
				['([0-9]+):([0-9]+):[0-9]+.*キングイグルー','NM07'],
				['([0-9]+):([0-9]+):[0-9]+.*アサグ','NM08'],
				['([0-9]+):([0-9]+):[0-9]+.*スラビー','NM09'],
				['([0-9]+):([0-9]+):[0-9]+.*キングアースロ','NM10'],
				['([0-9]+):([0-9]+):[0-9]+.*エルダータウルス','NM11'],
				['([0-9]+):([0-9]+):[0-9]+.*エウレカの聖牛','NM12'],
				['([0-9]+):([0-9]+):[0-9]+.*ハダヨッシュ','NM13'],
				['([0-9]+):([0-9]+):[0-9]+.*ホルス','NM14'],
				['([0-9]+):([0-9]+):[0-9]+.*アーチ・アンラ・マンユ','NM15'],
				['([0-9]+):([0-9]+):[0-9]+.*キャシー','NM16'],
				['([0-9]+):([0-9]+):[0-9]+.*ロウヒ','NM17']
			];
