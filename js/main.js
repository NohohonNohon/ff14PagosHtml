	...
	var global = {
		...
		*/
		resetData: function(msgFlag) {
			var tempNMData;
			var tempNMList;
			//	 NMLv,	NM,					Triger,				Lv,	Remarks,	x,	y,	shout1,				shout2
			tempNMData=[
				['20',	'雪上のしあわせうさぎ',			'不明',				'',	'',		'18.1',	'27.5',	'[1]雪うさぎ',			'雪うさぎ',		],
				['20',	'白き支配者「雪の女王」',		'ユキンコ',			'25',	'',		'21',	'26',	'[2]雪の女王',			'雪の女王',		],
				['21',	'腐れる読書家「タキシム」',		'デモン・オブ・レアブック',	'26',	'ET19:00～5:59','25',	'27',	'[3]タキシム',			'タキシム',		],
				['22',	'灰殻の鱗王「アッシュドラゴン」',	'ブラッドデーモン',		'27',	'',		'30',	'30',	'[4]アッシュドラゴン',		'ドラゴン',		],
				['23',	'地殻変動の謎「グラヴォイド」',		'バルウォーム',			'28',	'',		'33',	'27',	'[5]グラヴォイド',		'ヴォイド',		],
				['24',	'雪解けの化身「アナポ」',		'スノウメルトスプライト',	'29',	'霧',		'32.9',	'21.5',	'[6]アナポ',			'アナポ',		],
				['25',	'五行眼の主「ハクタク」',		'ブラバーアイズ',		'30',	'',		'28',	'22',	'[7]ハクタク',			'ハクタク',		],
				['26',	'動く雪洞「キングイグルー」',		'フワシ',			'31',	'',		'17',	'17',	'[8]キングイグルー',		'イグルー',		],
				['27',	'硬質の病魔「アサグ」',			'ワンダリング・オプケン',	'32',	'',		'10',	'11',	'[9]アサグ',			'アサグ',		],
				['28',	'家畜の慈母「スラビー」',		'パゴス・ビリー',		'33',	'',		'9',	'19',	'[10]スラビー',			'スラビー',		],
				...
				['35',	'蒼き氷刃「ロウヒ」',			'不明',				'40',	'',		'36',	'19',	'[19]ロウヒ',			'ロウヒ',		],
				['',	'予備',　				'不明',				'',	'',		'99',	'99',	'',				'',			]
			];
